  ...
  return (
    <>
      <Box sx={{ maxWidth: "1200px", margin: "0 auto", padding: "20px", border: "1px solid #ddd", borderRadius: "8px" }}>
        <SearchFields
          prarentComponent={parentName}
          formData={formData}
          handleChange={handleChange}
          handleSearch={handleSearch}
          onCsKindChange={handleCsKindChange}
        />
        <Box sx={{ padding: 2 }}>
          <CrudButtons onAdd={handleAddCustomer} onEdit={() => handleEditCustomer()} onDelete={() => handleDeleteCustomer()} />
          <div ref={tableRef} />
          <CustomerDialog open={dialogOpen} onClose={handleCloseModal} onSave={handleSaveCustomer} customer={selectedCustomer} />
        </Box>
      </Box>
    </>
  );
